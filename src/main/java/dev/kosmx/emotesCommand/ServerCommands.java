...
public final class ServerCommands {
    public static void registerCommands() {
        new CommandTree("emotes").withPermission(BukkitConnector.getEmoteUser())
                ...
                new LiteralArgument("play")
                        .then(((TextArgument) new TextArgument("emote").replaceSuggestions(new EmoteArgumentProvider()))
    ...
    private static class EmoteArgumentProvider implements ArgumentSuggestions {
        ...
        public CompletableFuture<Suggestions> suggest(SuggestionInfo info, SuggestionsBuilder builder) {
            HashMap<UUID, KeyframeAnimation> emotes = getEmotes(((CommandSender) info.sender()).hasPermission(BukkitConnector.getEmoteMaster().toString()));
